...
import com.example.ths_pondok.Adapter.AdapterSantriHafalan
...
class HafalanPerkelasActivity : AppCompatActivity() {

    val daftarSantri = mutableListOf<HashMap<String,String>>()
    lateinit var santriAdapter : AdapterSantriHafalan
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        santriAdapter = AdapterSantriHafalan(daftarSantri)
