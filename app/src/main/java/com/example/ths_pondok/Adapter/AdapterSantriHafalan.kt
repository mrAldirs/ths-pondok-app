...
class AdapterSantriHafalan(val daftarSantri: List<HashMap<String,String>>)
    : RecyclerView.Adapter<AdapterSantriHafalan.HolderDataSantri>(){
    ...
    override fun onBindViewHolder(holder: HolderDataSantri, position: Int) {
        ...
        holder.cd.setOnClickListener {
            val intent = Intent(it.context, HafalanPersantriActivity::class.java)
